...
$string['synthesis_help'] = 'Cliquer sur le bouton puis sélectionner le texte à écouter.';

$string['privacy:metadata'] = 'La bloc d\'aide à la lecture aide uniquement les utilisateurs et ne stocke pas de données.';
